    ...
    <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b bg-white px-6">
      ...
      <div className="flex-1 max-w-md">
        <div className="relative">
          ...
          <Input
            type="search"
            placeholder="Search tickets, contacts... (Cmd+K)"
            className="pl-10"
          />
        </div>
      </div>
          ...
          <DropdownMenuContent align="end" className="w-80">
            ...
            <DropdownMenuItem>
              <div className="flex flex-col gap-1">
                ...
                <p className="text-xs text-gray-500">T-0001: Unable to login - 5 mins ago</p>
              </div>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <div className="flex flex-col gap-1">
                <p className="text-sm font-medium">Ticket updated</p>
                <p className="text-xs text-gray-500">T-0003: Customer responded - 1 hour ago</p>
              </div>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <div className="flex flex-col gap-1">
                <p className="text-sm font-medium">High priority ticket</p>
                <p className="text-xs text-gray-500">T-0008: Dashboard slow - 2 hours ago</p>
              </div>
            </DropdownMenuItem>
            <DropdownMenuSeparator />
